...
<link href="<c:url value="/style/fullcalendar.css" />" rel="stylesheet">
<link href="<c:url value="/style/prettyPhoto.css" />" rel="stylesheet">
<link href="<c:url value="/style/rateit.css" />" rel="stylesheet">
<link href="<c:url value="/style/bootstrap-datetimepicker.min.css" />"
	rel="stylesheet">
<link href="<c:url value="/style/jquery.cleditor.css" />"
	rel="stylesheet">
<link href="<c:url value="/style/bootstrap-switch.css" />"
	rel="stylesheet">
<link href="<c:url value="/style/style.css" />" rel="stylesheet">
<link href="<c:url value="/style/widgets.css" />" rel="stylesheet">
<link href="<c:url value="/style/bootstrap-treeview.min.css" />"
	rel="stylesheet">
<link href="<c:url value="/vendor/css/vendor.css" />" rel="stylesheet">
<link href="<c:url value="/dist/formbuilder.css" />" rel="stylesheet">
<link href="<c:url value="/countdown/jquery.countdown.css" />" rel="stylesheet">
