...
(function() {
  ...
  BuilderView = (function(_super) {
    ...
    BuilderView.prototype.saveForm = function(e) {
      ...
      //}
      var myName = $("#shenpiName").val(); //审批名称的值
      var shenpiDEC=$("#shenpiDEC").val(); //审批描述
      var message=""; //表单验证错误信息
      if(!myName)
    	  message+="请输入审批名称\n";
      if(myName.length>20)
    	  message+="审批名称不能超过20个字符\n";
      if(!regStrName(myName))
    	  message+="审批名称只能包含汉子字母数字和下划线\n";
      if(!message){
      	var dataUpload={
      		'name':myName,
      		'dec': shenpiDEC,
      	...
      	var hideFormID=$("#hideFormID").val();
      	var ajaxUrl="";
      	if(hideFormID){
      		dataUpload.id=hideFormID;
      		ajaxUrl = rootUri + "/Form/updateform.json";
      	}
      	else
      		ajaxUrl = rootUri + "/Form/addform.json";
  ...
  Formbuilder = (function() {
    Formbuilder.helpers = {
      defaultFieldAttrs: function(field_type) {
        ...
        attrs[Formbuilder.options.mappings.NEED_PRINT] = true;
        attrs['field_options'] = {};
    ...
    Formbuilder.options = {
      ...
      mappings: {
        ...
        NEED_PRINT : 'need_print', //是否需要打印
        TIME_SPEND_TYPE : 'field_options.time_spend_type'
      },
      dict: {
...
(function() {
	Formbuilder.registerField('member', {
	  order: 53,
	  view: "<input type='text' placeholder='请选择成员' />",
	  edit: "",
	  addButton: "<span class=\"symbol\"><span class=\"fa fa-file\"></span></span> 成员"
	});

}).call(this);

(function() {
	Formbuilder.registerField('fileupload', {
	  order: 50,
	  view: "<input type='file' />",
	  edit: "",
	  addButton: "<span class=\"symbol\"><span class=\"fa fa-file\"></span></span> 文件上传"
	});

}).call(this);

(function() {
	  Formbuilder.registerField('timespend', {
	    order: 51,
	    view: "<div class='input-line'>\n  <span class='month'>\n    <input type=\"text\" />\n    <label>DD</label>\n  </span>\n\n  <span class='above-line'>/</span>\n\n  <span class='day'>\n    <input type=\"text\" />\n    <label>HH</label>\n  </span>\n\n  <span class='above-line'>/</span>\n\n  <span class='year'>\n    <input type=\"text\" />\n    <label>mm</label>\n  </span>\n</div>",
	    edit: "<%= Formbuilder.templates['edit/timespend']() %>",
	    addButton: "<span class=\"symbol\"><span class=\"fa fa-calendar\"></span></span> 处理用时"
	  });
...
(function() {
	  Formbuilder.registerField('table', {
	    order: 52,
	    view: "<table class='table table-striped table-bordered table-hover'><thead><tr><th>字段1</th><th>字段2</th><th>字段3</th></tr></thead><tbody><tr><td>value1</td><td>value2</td><td>value3</td></tr></tbody></table>",
	    edit: "<%= Formbuilder.templates['edit/table']() %>",
	    addButton: "<span class=\"symbol\"><span class=\"fa fa-square-o\"></span></span> Table",
...
(function() {
  Formbuilder.registerField('dropdown', {
    ...
    addButton: "<span class=\"symbol\"><span class=\"fa fa-caret-down\"></span></span> 下拉单选",
    defaultAttributes: function(attrs) {
      attrs.field_options.options = [
        {
          label: "",
...
(function() {
	Formbuilder.registerField('linkdropdown',{
		order : 46,
		view : "下拉1<select>\n </select><br>下拉2<select>\n </select>",
		edit : "<%= Formbuilder.templates['edit/linkoptions']() %>",
		addButton : "<span class=\"symbol\"><span class=\"fa fa-caret-down\"></span></span> 联动下拉",
		defaultAttributes : function(attrs) {
			attrs.field_options.options = [ 
			  {
				label : "",
...
/*
 * (function() { Formbuilder.registerField('email', { order: 40, view: "<input
 * type='text' class='rf-size-<%= rf.get(Formbuilder.options.mappings.SIZE) %>'
 * />", edit: "", addButton: "<span class=\"symbol\"><span class=\"fa
 * fa-envelope-o\"></span></span> Email" });
 * 
 * }).call(this);
 */
...
'\' />\n  Required\n</label>\n'+
'<label>\n  <br>\n<input type=\'checkbox\' data-rv-checked=\'model.' +
((__t = ( Formbuilder.options.mappings.NEED_PRINT )) == null ? '' : __t) +
'\' />\n  是否需要打印\n</label>\n'+
'<!-- label>\n  <input type=\'checkbox\' data-rv-checked=\'model.' +
...
this["Formbuilder"]["templates"]["edit/linkoptions"] = function(obj) {
	obj || (obj = {});
	var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
	function print() { __p += __j.call(arguments, '') }
	with (obj) {
	__p += '<div class=\'fb-edit-section-header\'>Options<br>第一个参数为名称，第二个参数为接口</div>\n\n';
	
	__p += '\n\n<div class=\'option\' data-rv-each-option=\'model.' +
	((__t = ( Formbuilder.options.mappings.OPTIONS )) == null ? '' : __t) +
	'\'>\n  <input type="text" class=\'js-default-updated\' data-rv-input="option:checked" />\n  <input type="text" data-rv-input="option:label" class=\'option-label-input\' />\n  <a class="js-add-option ' +
	((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
	'" title="Add Option"><i class=\'fa fa-plus-circle\'></i></a>\n  <a class="js-remove-option ' +
	((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
	'" title="Remove Option"><i class=\'fa fa-minus-circle\'></i></a>\n</div>\n\n';
	...
	this["Formbuilder"]["templates"]["edit/table"] = function(obj) {
		obj || (obj = {});
		var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
		function print() { __p += __j.call(arguments, '') }
		with (obj) {
		...
		__p += '\n\n<div class=\'option\' data-rv-each-option=\'model.' +
		((__t = ( Formbuilder.options.mappings.OPTIONS )) == null ? '' : __t) +
		'\'>\n  <input type="text" class=\'js-default-updated\' data-rv-input="option:label" />\n <a class="js-add-option ' +
		((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
		'" title="Add Option"><i class=\'fa fa-plus-circle\'></i></a>\n  <a class="js-remove-option ' +
		((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
		'" title="Remove Option"><i class=\'fa fa-minus-circle\'></i></a>\n</div>\n\n';
...
this["Formbuilder"]["templates"]["edit/timespend"] = function(obj) {
	obj || (obj = {});
	var __t, __p = '', __e = _.escape;
	with (obj) {
	__p += '<div class=\'fb-edit-section-header\'>类型</div>\n<select data-rv-value="model.' +
	((__t = ( Formbuilder.options.mappings.TIME_SPEND_TYPE )) == null ? '' : __t) +
	'">\n  <option value="task">任务用时</option>\n  <option value="processinstance">全部用时</option>\n';
